...
class PdfViewerScreen extends StatelessWidget {
  ...
  String replaceAll(String content) {
    ...
    content =
        content.replaceAll('{lender_id_card_issued_by}', 'People\'s Committee');
    ...
    content = content.replaceAll(
        '{lender_bank_branch}', contract.lenderBankCard!.branch ?? "A.A");
    content =
    ...
    content = content.replaceAll(
        '{borrower_id_card_issued_by}', 'People\'s Committee');
    ...
    content = content.replaceAll(
        '{borrower_bank_branch}', contract.borrowerBankCard!.branch ?? "A.A");
    content =
