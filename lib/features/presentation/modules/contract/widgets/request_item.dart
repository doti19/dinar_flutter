  ...
  String getStatusText() {
    switch (request.status!) {
      case LoanContractRequestStatus.cancle:
        return "Confirmed from ${request.createdAt!.toDMYString()}";
      case LoanContractRequestStatus.waitingForPayment:
        return "Wait for pay";
      case LoanContractRequestStatus.rejected:
        return request.rejectedReason ?? "Cancelled";
      case LoanContractRequestStatus.paid:
        return "Paid from ${request.updatedAt!.toDMYString()}";
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(
                                "${request.loanAmount!.toInt().formatNumberWithCommas} ETB",
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${request.loanTenureMonths} month",
                                style: AppTextStyles.bold12
                                    .colorEx(AppColors.black),
                              ),
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${request.overdueInterestRate} % / month",
                                style: AppTextStyles.bold12
                                    .colorEx(AppColors.black),
                              ),
                            ],
