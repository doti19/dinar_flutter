...
import 'package:dinar/features/domain/usecases/contract/get_loan_requests_approved.dart';
import 'package:dinar/features/domain/usecases/contract/get_loan_requests_pending.dart';
...
import 'package:dinar/features/domain/usecases/contract/reject_request.dart';
  ...
  Future<void> rejectRequest(LoanRequestEntity request, String reason) async {
    ...
    if (dataState is DataSuccess) {
      Get.snackbar(
        ...
        'See information in the opt-out section',
