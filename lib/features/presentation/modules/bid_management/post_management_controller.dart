...
import 'package:dinar/features/domain/usecases/post/remote/get_posts_hided.dart';
import 'package:dinar/features/domain/usecases/post/remote/get_posts_pending.dart';
...
class BidManagementController extends GetxController {
  RxList<BidEntity> pendingPosts = <BidEntity>[].obs;
  RxList<BidEntity> approvedPosts = <BidEntity>[].obs;
  RxList<BidEntity> rejectedPosts = <BidEntity>[].obs;
  RxList<BidEntity> hidedPosts = <BidEntity>[].obs;
  RxList<BidEntity> expiredPosts = <BidEntity>[].obs;
