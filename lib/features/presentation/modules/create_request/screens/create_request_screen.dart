...
import 'package:dinar/features/presentation/modules/create_request/widgets/images_form.dart';
import 'package:dinar/features/presentation/modules/create_request/widgets/loan_info_form.dart';
...
class _CreateRequestScreenState extends State<CreateRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppbar(title: "Create loan request"),
      body: ListView(
        children: [
          Form(
