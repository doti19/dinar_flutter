...
import 'package:dinar/features/domain/usecases/user/search_user_usecase.dart';
...
class CreateRequestController extends GetxController {
  ...
  Future<void> createRequest() async {
    ...
    if (dataState is DataSuccess) {
      ...
      Get.snackbar(
        ...
        'Go to the contract section to view your request',
  ...
  Future<LoanRequestEntity> getNewRequest() async {
    if (portrait.value == null ||
      ...
      return Future.error('Please select a photo');
    }
