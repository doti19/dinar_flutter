...
class _ImageAvatarPickerState extends State<ImageAvatarPicker> {
  ...
  Widget showFace() {
    ...
    } else if (accController.me.value!.avatar != null) {
      print('doti ${apiDevBaseUrl}/images/${accController.me.value!.avatar!}');
      print('am here');
      return Image.network(
        '${apiDevBaseUrl}/images/${accController.me.value!.avatar!}',
        fit: BoxFit.cover,
        width: imageSize.wp,
        height: imageSize.wp,
