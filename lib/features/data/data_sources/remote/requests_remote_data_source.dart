...
import 'package:dinar/features/data/models/credit/transaction.dart';
...
class RequestRemoteDataSrcImpl implements RequestRemoteDataSrc {
  ...
  Future<HttpResponse<Pair<int, List<ContractModel>>>> getContracts(
    ...
    String role = isLending ? '/lender' : '/borrower';

    String url = '$apiUrl$kGetContractEndpoint$role${queryBuilder.build()}';
