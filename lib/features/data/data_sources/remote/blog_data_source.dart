import 'package:dinar/features/data/models/blog/blog_model.dart';
...
class BlogRemoteDataSrcImpl implements BlogRemoteDataSrc {
  ...
  Future<HttpResponse<List<BlogModel>>> getAllBlogs() async {
    ...
    try {
      ...
      print('abrsh ${response.data}');

      final List<DataMap> taskDataList = List<DataMap>.from(response.data);
